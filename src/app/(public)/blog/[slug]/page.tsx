...
import { Clock, Eye, Heart, Calendar, ArrowLeft, Twitter, Github, Globe } from "lucide-react";
...
export default async function ArticlePage({ params }: ArticlePageProps) {
  ...
  return (
    <article className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      ...
      {/* Hero Cover Image */}
      <div className="relative aspect-[21/9] w-full overflow-hidden rounded-3xl mb-12 shadow-xl border border-slate-200 dark:border-slate-800">
        <Image
          src={post.coverImage}
          alt={post.title}
          fill
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div className="lg:col-span-8">
          ...
          {/* Author Bio Box */}
          <div className="my-10 p-6 rounded-2xl bg-slate-50 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800 flex flex-col sm:flex-row items-start sm:items-center gap-5">
            <Image
              src={post.author.avatar}
              alt={post.author.name}
              width={64}
              height={64}
              className="rounded-full object-cover ring-4 ring-white dark:ring-slate-800"
            />
        ...
        <aside className="hidden lg:block lg:col-span-4 space-y-6">
          <div className="sticky top-24 space-y-6">
            ...
            <div className="p-5 rounded-2xl border border-slate-200/80 bg-white dark:border-slate-800/80 dark:bg-slate-900/40 space-y-3">
